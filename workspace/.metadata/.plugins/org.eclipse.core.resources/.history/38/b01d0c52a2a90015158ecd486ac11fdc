...
public class FrameConnexion extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==connexion)
		{
			...
			else if(log.getText()=="enseignant" && mdp.getText().toString()=="enseignant")
			{	
				this.dispose();
				new FrameSoutenance();
			}
			...
			{
				JOptionPane.showMessageDialog(this,"Erreur de saisie ressayer !","Erreur connexion",JOptionPane.ERROR_MESSAGE);
			}
