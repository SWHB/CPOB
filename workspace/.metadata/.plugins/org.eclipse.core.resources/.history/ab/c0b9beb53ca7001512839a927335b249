...
public class FrameListeEtudiant extends JFrame {
	...
	private String infoetu[];
		...
		public void creercomposant()
		{
		 ...
		 this.lbletu.setBorder(BorderFactory.createTitledBorder( "Informations étudiant:"));
		 ...
		 this.listEtu.setBorder(BorderFactory.createTitledBorder( "Liste étudiant:"));
		 this.add(this.listEtu, BorderLayout.WEST);		
		 }
		
		//Méthode pour l'affichage des information à partir un JList sur un JLabel
